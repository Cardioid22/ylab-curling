...
- **【第2波 実行中 (2026-08-30 投入, 読み取り確認済み)】** bear=A1N (500局面, noisy-tree 対照) / jaguar=A2 / lion=A9 / tiger=A5 (各 新規300, `--start-index 200 --max-positions 300`)。
  全 5 seed、フラグ・スライス確認、エラーなし。目安 1-1.5 日。任意の A2N / A11aN は未投入。
